...
const Home = () =>{
	return(
        ...
        <div ><div > 
          <h1><img className="animate__animated animate__flip animate__slower animate__infinite" src= {require('./imgs/camm.png')} alt="discrption pic" width="70px" height="70px" /> AL RAYAN CO.</h1>
...
لقد وفرنا لكم أفضل الخدمات متواجدة في أكبر مركز تركيب الدش بالتجمع، في مجال تركيب الدش والريسيفر، ومتوفر لدينا أيضاً جميع مستلزمات تركيب الدش والريسيفر، وتركيب الشاشات. </p>
           </div></div>  
		  <div className="item3">
