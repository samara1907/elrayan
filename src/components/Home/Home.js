	...
	return(
        ...
        <div className="bg animate__animated animate__backInLeft animate__delay-1s">
          ...
          <img src={require('./imgs/Satellite-Installation-Technician-Worker_art.png')} alt="dish" width="300px" height="300px"/>
               ...
               <p>.تقدم الشركة جميع خدمات الدش الثابت و المتحرك.  التي تضمن مجموعة كاملة من أعمال و خدمات تركيب و صيانة الدش الثابت و المركزي و المتحرك و تأسيس الشبكات الداخلية و صيانة جميع انواع الريسيفرات من خلال مجموعة من افضل الفينين المتخصصين في مجال تركيب و صيانة الدش. كما تتوفر لدينا جميع انواع قطع الغيار (أطباق دش - ريسيفرات - حوامل شاشات - أسلاك - لاقط إشارة). كما توفر الشركة جميع المستلزمات و الأكسسوارات الإضافية عند الطلب. و تقدم شركة الريان ضمان لمدة عام علي جميع قطع الغيار.  و تتشرف الريان بتقديم خدمة سريعة و متقنة. حيث نقوم بتنسيق المواعيد المناسبة لأوقاتكم عند طلب الفني. تقوم الريان بتنسيق الميعاد معكم. كما يقوم الفني بالتواصل معكم لتأكيد الميعاد.  </p>
           </div></div>  
		  <div className="item3">
